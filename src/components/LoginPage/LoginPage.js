  ...
  return (
    <div className="loginPage">
        ...
        <div className="loginPage__container">
            ...
            <input type="email" maxlength="128" id="email" className="loginPage__input" />
        ...
        <div className="loginPage__container2">
            <h5>New to Amazon?</h5>
            <button className="loginPage__createNewAccountButton">Create your Amazon account</button>
        </div>
